...
print(x)
N = np.linalg.solve(M, M.T) # (M.T est un attribut (variable d'instance) des objet Numpy (la version transporté))
print(N)
...
# on défini x, et on l'appelle pour la fonction des ordonnés du plot
...
plt.title('Figure 3: SuiteSn en fonction de la valeur de n')
plt.xlabel('n')
plt.ylabel('Sn')
